...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/clazz/js/showClazz.js"></script>
...
<body>
	...
	<div class="search">
	<label>查找条件：</label><br/>
	<form action="${pageContext.request.contextPath }/findAllClazz" method="get" id="searchForm" class="center">
          <div>
                       班级号：<input type="text" name="id" id="id" value=""/>			
		  </div>
		  <div>
	  ...
	  <br>
	  <input type="button" onclick="searchClazz()" value="查找"/>
	  &nbsp;&nbsp;&nbsp;&nbsp;
