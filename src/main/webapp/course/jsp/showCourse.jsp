...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/course/js/showCourse.js"></script>
...
<body>
	...
	<div class="search">
	<label>查找条件：</label><br/>
	<form action="${pageContext.request.contextPath }/findAllCourse" method="get" id="searchForm" class="center">
          <div>
                       课程号：<input type="text" name="id" id="id" value=""/>			
		  </div>
		  <div>
		   课程名：<input type="text" name="name" id="name" value=""/>
		  </div>
	  <br>
	  <input type="button" onclick="searchCourse()" value="查找"/>
	  &nbsp;&nbsp;&nbsp;&nbsp;
