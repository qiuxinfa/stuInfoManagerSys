...
<title>新增专业信息</title>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/major/js/addMajor.js"></script>
...
<body>
    <h3>新增学生信息：</h3>
    <br>
	<form action="${pageContext.request.contextPath }/addMajor" method="get" id="addForm" class="center">
          <div>
	    ...
	    <br><br>
		<input type="button" name="submit" value="添加" onclick="addMajor()"></input>
		&nbsp;&nbsp;&nbsp;&nbsp;
